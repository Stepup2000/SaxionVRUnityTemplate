...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRPushButton : UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable
    {
        ...
        class PressInfo
        {
            internal UnityEngine.XR.Interaction.Toolkit.Interactors.IXRHoverInteractor m_Interactor; // Reference to the interactor
        ...
        private Dictionary<UnityEngine.XR.Interaction.Toolkit.Interactors.IXRHoverInteractor, PressInfo> m_HoveringInteractors = new Dictionary<UnityEngine.XR.Interaction.Toolkit.Interactors.IXRHoverInteractor, PressInfo>(); // Tracks interactors hovering over the button
